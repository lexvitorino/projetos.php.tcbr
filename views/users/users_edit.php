...
<form method="POST">
	...
	<input type="text" name="login" value="<?php echo $user['login']; ?>" required/><br/><br/>
	...
	<option value="<?php echo $item['id'] ?>" <?php echo ($item['id']==$user['id_group'])?'selected="selected"':''; ?>> <?php echo $item['name']; ?></option>
	<?php endforeach; ?>
	</select><br/><br/>
